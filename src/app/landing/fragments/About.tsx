...
export default function StatsCTA() {
  return (
    <section
      id="about"
      className="space-y-10 bg-[var(--background)] px-6 py-8 sm:py-18"
    >
      {/* Stats */}
      ...
      {/* CTA */}
      <div className="mx-auto mt-10 max-w-4xl rounded-xl border border-[var(--border)] bg-[var(--surface)] px-6 py-8 text-center sm:mt-30 sm:py-10">
