...
export default function Hero() {
  return (
    <section className="bg-[#070B14] px-6 py-20 sm:py-24 lg:px-10 lg:py-18">
      <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
        <div className="pl-12">
          <div className="inline-flex items-center gap-2 rounded-full border border-blue-500/60 px-3 py-1 text-[9px] uppercase tracking-wide text-blue-400">
            <ShieldCheck size={12} />
            <span className="pt-0.5">AI-powered job scam detection</span>
          </div>
